...
{
   private TrieNode1 parent;
   private static TrieNode1[] children;
    ...
    */
   public TrieNode1(char character)
   {
      this();
   ...
   protected void addWord(String word)
   {
      ...
      {
      children[charPos] = new TrieNode1(word.charAt(0));
    ...
    * @return
    */
   protected static TrieNode1 getNode(char c)
   {
      return children[c - 'a'];
   }
